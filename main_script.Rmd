...
Collapse high cardinality factors, weighted based on revenue.
```{r, echo=F}
...
clean_data = clean_data %>% 
  mutate(browser=fct_lump_n(browser, w=revenue, n=4),
         ...
         country=fct_lump_n(country, w=revenue, n=5)) 
clean_data %>% str()
```
...
There's a diference between who's a new clients who's not 
