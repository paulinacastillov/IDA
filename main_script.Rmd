...
factor_vars = setdiff(names(raw_data), c(chr_vars,num_vars,log_vars,date_vars,datetime_vars))
...
Model with LASSO for comparision
```{r, echo=F}

#sampled_data = data_aggregated %>% slice_sample(n=10000)
